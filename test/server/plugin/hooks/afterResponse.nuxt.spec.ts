...
describe('afterResponse nitro hook handler', () => {
  ...
  test('Puts a cacheable item in cache.', async () => {
    ...
    expect(storedItems[0]).toMatchInlineSnapshot(`
      {
        "item": "{"headers":{"x-test":"foobar"},"statusCode":200,"expires":1672320000,"cacheTags":[],"staleIfErrorExpires":0,"staleWhileRevalidate":false,"enableBackgroundRevalidation":null}<CACHE_ITEM><html></html>",
        "key": "/foobar",
        "options": {
          "ttl": 1200,
        },
